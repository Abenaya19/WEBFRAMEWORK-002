package com.example.abeclass_exercise_1.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AbeChildren {
     @Id
     private int babyId;
     ...
     public AbeChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
